        ...
        <form role="form" novalidate>
            ...
            <div class="form-group">
                ...
                <div class="input-group">    
                    ...
                    <span ng-class="valColor ? 'bg-success' : 'bg-danger'" class="input-group-addon"><span ng-class="valColor ? 'glyphicon-ok' : 'glyphicon-remove'" class="glyphicon" aria-hidden="true"></span></span>      
                </div>
            </div> 
            <div class="form-group">
                ...
                <div class="input-group">     
                    ...
                    <span ng-class="valColor ? 'bg-success' : 'bg-danger'" class="input-group-addon"><span ng-class="valColor ? 'glyphicon-ok' : 'glyphicon-remove'" class="glyphicon" aria-hidden="true"></span>
                </span>
                </div>
            </div>     
    ...
    <h4>Angular data-binding</h4>
        ...
        <div ng-show="showPassArea">
            <ul class="list-group">
                ...
                <li class="list-group-item">Password Match: <span class="text-success">{{pass.password}}</span><div class="pull-right check_square_danger" ng-class="checkColor ? 'bg-success' : 'bg-danger'"><span ng-class="checkColor ? 'glyphicon-ok' : 'glyphicon-remove'" class="glyphicon" aria-hidden="true"></span></div></li>
